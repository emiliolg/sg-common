...
public class Tuple6<T, U, V, W, X, Y> extends Tuple5<T, U, V, W, X> {
    ...
    protected Tuple6(@NotNull T first, @NotNull U second, @NotNull V third, @NotNull W fourth, @NotNull X fifth, @NotNull Y sixth) {
    ...
    public boolean equals(Object obj) {
        return this == obj || obj instanceof Tuple6 && super.equals(obj) && equal(sixth, ((Tuple6<T, U, V, W, X, Y>) obj).sixth);
    }

    @Override public int hashCode() {
        return hashCodeAll(first(), second(), third(), fourth(), fifth(), sixth());
    }
